...
server <- function(input, output, session) {
  ...
  withProgress(message="Loading data...", value=0, {
    ...
    #subject <- "3"        # invasive species (subject)
